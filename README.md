...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ak2m7sa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ak2m7sa.containers.anotherwebservice.com/
...
```
git clone git@github.com:igor04091968/container-ak2m7sa.git
cd container-ak2m7sa
```
...
```
docker attach container-ak2m7sa
```
